...
class OrderController extends Controller
{
    ...
    {
        $query = Order::with('user', 'items.product', 'items.productVariant', 'mesa', 'metodoPago', 'client');
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return response()->json($order->load('items.product', 'items.productVariant', 'mesa'), 201);
        } catch (\Exception $e) {
    ...
    {
        return $order->load('user', 'items.product', 'items.productVariant', 'mesa', 'metodoPago', 'client');
    }
    ...
    public function updateStatus(Request $request, Order $order)
    {
        ...
        try {
            ...
            return response()->json($order->fresh()->load('items.product', 'items.productVariant'));
        } catch (\Exception $e) {
            return response()->json(['message' => $e->getMessage()], 422);
        }
    }
