    ...
    <GuestLayout>
        ...
        <div class="space-y-5">
            <div class="text-center">
                <h2 class="text-2xl font-black text-gray-900">Confirmar Contraseña</h2>
                <p class="text-sm text-gray-500 mt-1">Esta es un área segura. Confirma tu contraseña para continuar.</p>
            </div>
